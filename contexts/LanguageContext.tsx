...
const translations = {
  ...
  'home.follow.title': 'Bizi Takip Edin',
  'home.follow.subtitle': 'Havacılar A.Ş. sosyal medya hesapları',
  'home.follow.instagram': 'Instagram',
  'home.follow.linkedin': 'LinkedIn',
  'home.follow.view': 'Görüntüle',
  'home.subsidiaries.title': 'Yan Kuruluşlarımız',
  'home.subsidiaries.website': 'Web sitesi',
  'home.subsidiaries.instagram': 'Instagram',
  'home.subsidiaries.youtube': 'YouTube',
  'home.subsidiaries.linkedin': 'LinkedIn',
  ...
  'category.corporate': 'Kurumsal',
  'category.general': 'Genel',
  'announcements.hero.subtitle': 'En güncel haberler ve duyurularımızı takip edin.',
  'announcements.filter.all': 'Tümü',
  'announcements.filter.aviation': 'Havacılık',
  'announcements.filter.realestate': 'Gayrimenkul',
  'announcements.filter.corporate': 'Kurumsal',
  'announcements.readmore': 'Devamını Oku',
  'announcements.empty': 'Bu kategoride henüz duyuru bulunmamaktadır.',
  'announcements.newsletter.title': 'Haberlerimizi Kaçırmayın',
  'announcements.newsletter.desc': 'En güncel duyurularımızı e-posta ile almak için bültenimize abone olun.',
  'announcements.newsletter.placeholder': 'E-posta adresiniz',
  'announcements.newsletter.subscribe': 'Abone Ol',
  'announcements.back': 'Tüm duyurular',

  // Contact page i18n
  'contact.form.title': 'Bizimle İletişime Geçin',
  'contact.form.submitting': 'Gönderiliyor...',
  'contact.form.success.title': 'Mesajınız Gönderildi! ',
  'contact.form.success.desc': 'En kısa sürede size geri dönüş yapacağız.',
  'contact.form.phone': 'Telefon',
  'contact.form.subject': 'Konu',
  'contact.form.subject.placeholder': 'Konu seçiniz',
  'contact.subject.realestate': 'Gayrimenkul Projeleri',
  'contact.subject.aviation': 'Havacılık Projeleri',
  'contact.subject.investment': 'Yatırım Danışmanlığı',
  'contact.subject.partnership': 'İş Ortaklığı',
  ...
  'contact.form.phone.placeholder': '+90 555 123 45 67',
  'contact.form.message.placeholder': 'Mesajınızı buraya yazın...',
  'contact.info.title': 'İletişim Bilgileri',
  'contact.quicklinks.title': 'Hızlı Erişim',
  'contact.map.title': 'Ofis Lokasyonumuz',

  // Blog
  'blog.hero.subtitle': 'Yatırım, havacılık ve gayrimenkul alanındaki içeriklerimizi keşfedin.',
  ...
  'home.follow.subtitle': 'Havacılar A.Ş. social media accounts',
  'home.follow.instagram': 'Instagram',
  'home.follow.linkedin': 'LinkedIn',
  'home.follow.view': 'View',
  'home.subsidiaries.title': 'Our Subsidiaries',
  'home.subsidiaries.website': 'Website',
  'home.subsidiaries.instagram': 'Instagram',
  'home.subsidiaries.youtube': 'YouTube',
  'home.subsidiaries.linkedin': 'LinkedIn',
  ...
  'announcements.hero.subtitle': 'Follow our latest news and announcements.',
  'announcements.filter.all': 'All',
  'announcements.filter.aviation': 'Aviation',
  'announcements.filter.realestate': 'Real Estate',
  'announcements.filter.corporate': 'Corporate',
  'announcements.readmore': 'Read More',
  'announcements.empty': 'No announcements in this category yet.',
  'announcements.newsletter.title': "Don't Miss Our News",
  'announcements.newsletter.desc': 'Subscribe to our newsletter to receive our latest announcements by email.',
  'announcements.newsletter.placeholder': 'Your email address',
  'announcements.newsletter.subscribe': 'Subscribe',
  'announcements.back': 'All announcements',

  // Contact page i18n
  'contact.form.title': 'Get in Touch',
  'contact.form.submitting': 'Sending...',
  'contact.form.success.title': 'Your Message Was Sent!',
  ...
  'contact.subject.realestate': 'Real Estate Projects',
  'contact.subject.aviation': 'Aviation Projects',
  'contact.subject.investment': 'Investment Consultancy',
  ...
  'contact.quicklinks.title': 'Quick Access',
  'contact.map.title': 'Our Office Location',

  // Blog
  'blog.hero.subtitle': 'Explore our content on investment, aviation, and real estate.',
